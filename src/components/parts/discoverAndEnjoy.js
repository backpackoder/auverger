        ...
        <div className="descrBlockWrapper">
            ...
            <div className="descrBlock">
                ...
                <div className="descrBlock-row">
                    <img data-aos="fade-up" src="https://cf.bstatic.com/xdata/images/hotel/max1280x900/401644009.jpg?k=8e3e32113b9ebe407adcfb13fec79044b6495104202de0a26e7968aa99c4020b&o=&hp=1"
                    alt="L'établissement"
                        className="descrBlockImg" />
                    <p data-aos="fade-up" className="mainDescr">Situé à Sospel, les couples apprécient particulièrement l'emplacement de cet établissement.
    ...
    return (
        <div className="descrBlockWrapper">
            ...
            <div className="descrBlock">
                ...
                <div className="descrBlock-row">
                    <img data-aos="fade-up" src="https://cf.bstatic.com/xdata/images/hotel/max1280x900/101637024.jpg?k=49da771f41ef74d150d9023c0b30423fa163683afa609ea6b574cf8bd367432f&o=&hp=1"
                    alt="La piscine"
                        className="descrBlockImg" />
                    <p data-aos="fade-up" className="mainDescr">Relaxez-vous dans la piscine extérieure ouverte en saison avec vue sur les montagnes.
