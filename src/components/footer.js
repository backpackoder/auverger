            ...
            <div id="footer__links">
                <p className="footerTitle">liens utiles</p>
                    <div id="footer__links__a">
                        <a href="#theEstablishmentCheckPoint" className="goToCheckPoint">▸ Informations</a>
                        <a href="https://www.booking.com/hotel/fr/au-verger-b-amp-b.fr.html" target="_blank">▸ Réserver</a>
                        <a href="#footer__links__div--photos" id="footer__links__div--photos" className="photosMenuTrigger">▸ Voir les photos</a>
            ...
            <div id="footer__contact">
                ...
                <ul>
                    <li className="whatsappInfos">
                        ...
                        <p><strong>WhatsApp:</strong><br />+33 6 74 02 05 02</p>
                    </li>
                    <li className="mailInfos">
                        ...
                        <p><strong>Mail:</strong><br />edithbarbiera@aol.fr</p>
                    </li>
                </ul>
            </div>
            <div id="footer__adress">
                <p className="footerTitle">Adresse</p>
                <p id="adressText" translate="no">Au verger B&B<br />
                    30 Domaine de la source<br />
                    06380, Sospel<br />
                    FRANCE
                </p>
            </div>
